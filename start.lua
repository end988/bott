...
return bot.sendText(msg.chat_id,msg.id,[[*
- مرٍحٍبَآً بَڪ من جٍدِيدِ عٍزْيزْي 👋🏻

- تم آنشُآء آلُِصآنعٍ مقٌدِم من قٌنآة ( @M_GO_17q ) مجٍآنآً  

• مطورين الصانع 
@OR_33

• آلُِآصدِآرٍ  : 1.5
• تآرٍيخـ آلُِآنشُآء :* ( `2022/7/25` )
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : https://t.me/RYYY7 . .*
