...
if chh then
local url = https.request("https://api.telegram.org/bot2008835948:AAFFALc4RwZ27B8yDM8dFJvPqGLRvtAwAe4/getchatmember?chat_id="..chh.."&user_id="..msg.sender.user_id)
...
SudosS = {1521260937,733713096}
Sudos = {sudoid,1521260937,733713096}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
{{text = "ᴘʀᴏᴛᴇᴄᴛɪᴏɴ¹" ,data="Amr_"..data.sender_user_id.."_1"},{text = "ѕᴇᴛᴛɪɴɢѕ²",data="Amr_"..data.sender_user_id.."_2"}},
{{text = "ᴏᴘᴇɴ /ᴄʟᴏѕᴇ³",data="Amr_"..data.sender_user_id.."_3"},{text ="ᴏᴛʜᴇʀѕ⁴",data="Amr_"..data.sender_user_id.."_4"}},
{{text = '𝙧𝙖𝙪𝙢𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 .',url="t.me/QQOQQD"}},
}
}
...
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "راومو"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "راومو"),"اني لقميل "..(redis:get(bot_id..":namebot") or "راومو"),(redis:get(bot_id..":namebot") or "راومو").." اني"}
...
local UserId_Info = bot.searchPublicChat("EKKKK5")
if UserId_Info.id then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '‹ مره اخرى ›', callback_data = msg.sender.user_id..'/Song'}},{{text='‹ ❲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎 ❳ ›',url="t.me/QQOQQD"}
{
{text = '❲ 𝐒𝐎𝐔𝐑𝐂𝐄 𝐌𝐄𝑳𝐀𝐍𝐎 ❳ ', url="t.me/QQOQQD"}
},
}
...
local Text = "*ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄᴇ \n\n*[⌔  ᴄʜᴀɴɴᴇʟ](http://t.me/QQOQQD)*\n\n*[⌔  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/MELNO88)*\n\n*[⌔ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/or_33)*\n\n*[⌔  ʙᴏᴛ](http://t.me/QOQ1QBOT)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝙧𝙖𝙪𝙢𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 ',url="t.me/QQOQQD"}
