...
{
{text = 'قناة السورس', url='https://t.me/RYYY7'},
},
}
}
...
{
{text = '𝑺𝒐𝒖𝒓𝒄𝒆', url='https://t.me/RYYY7'},
},
}
}
LuaTele.sendText(msg_chat_id,msg_id,[[
...
data = {
{
{text = '❲ 𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓🎖 ❳', url = "https://t.me/RYYY7"}
},
{
{text = '- DEV .', url = "https://t.me/SELVER7"}
},
}
}
...
fne = Redis:get(FDFGERB..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"• ي : "..alzog.." زوجك يبيك ","md")
else
